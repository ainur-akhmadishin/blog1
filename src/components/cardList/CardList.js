...
const CardList = ({articles, onPage, fetchData, page, loading}) => {
...
const pagination = !loading ? <Pagination className = {classes['ant-pagination']} defaultCurrent={page} total={500} size="small" defaultPageSize={20}  showSizeChanger={false} onChange = {onPage} />  : null;

		
	
	return(
	<div className = {classes.CardList}>
								 	<div  className={classes['CardList--spinner']}>				   
	{spinner}
	</div>	
		{result}
		{pagination}		
